...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->WhiteAI", this::whiteAI);
        addMenuButton("Game->WhiteManual", this::whiteManual);
        addMenuButton("Game->BlackAI", this::blackAI);
        addMenuButton("Game->BlackManual", this::blackManual);
